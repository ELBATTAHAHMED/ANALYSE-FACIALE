...
session_start();
if (isset($_SESSION["user_id"]) && isset($_GET['emp_id'])){
    ...
    $key1 = $stmt->fetch(PDO::FETCH_ASSOC);

    // Récupère les informations de profil de l'employé en fonction de son ID
    $stmt = $pdo->prepare("SELECT * FROM employee WHERE emp_id = ?");
                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center">
                            ...
                            <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                <img class="avatar lg rounded-circle img-thumbnail" src="<?php echo htmlspecialchars($key1['profile_image']); ?>" alt="profile">
                            </a>
                            <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div class="card border-0 w280">
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            <img class="avatar rounded-circle" src="<?php echo htmlspecialchars($key1['profile_image']); ?>" alt="profile">
                        ...
                        <div class="card teacher-card  mb-3">
                            <div class="card-body  d-flex teacher-fulldeatil">
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    ...
                                    <span class="py-1 fw-bold small-11 mb-0 mt-1 text-muted"><?php echo htmlspecialchars($key['department']); ?></span>
                                    <p class="mt-2 small"><?php echo htmlspecialchars($key['description']); ?></p>
